...
func resourceComputeInstanceGroupManagerCreate(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] Creating new InstanceGroupManager: %#v", obj)
...
func resourceComputeInstanceGroupManagerUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] Updating InstanceGroupManager %q: %#v", d.Id(), obj)
...
func resourceComputeInstanceGroupManagerDelete(d *schema.ResourceData, meta interface{}) error {
	...
	log.Printf("[DEBUG] Deleting InstanceGroupManager %q", d.Id())
	...
	err = computeOperationWait(config.clientCompute, op, project, "Deleting InstanceGroupManager")
	if err != nil {
		return err
	}
